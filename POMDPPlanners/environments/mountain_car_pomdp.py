...
from POMDPPlanners.core.environment import DiscreteActionsEnvironment, StateTransitionModel, ObservationModel
...
class MountainCarObservation(ObservationModel):
    ...
    def probability(self, next_observation: Tuple[float, float]):
        ...
        return scipy.stats.multivariate_normal.pdf(obs_array, mean=self.mean, cov=self.cov_matrix)
