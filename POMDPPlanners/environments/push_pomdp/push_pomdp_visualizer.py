...
class PushPOMDPVisualizer:
    ...
    def create_visualization(self, history: List[StepData], cache_path: Path) -> None:
        ...
        robot_path_line, object_path_line = self._initialize_path_lines(ax)
    ...
    def _initialize_path_lines(self, ax: Axes) -> Tuple[Line2D, Line2D]:
        ...
        return robot_path_line, object_path_line
    ...
    def _update_path_traces(
        self,
        robot_path_line: Line2D,
        object_path_line: Line2D,
        states: List[Any],
        frame: int,
    ) -> None:
    ...
    def _create_animate_function(
        ...
        def animate(frame: int) -> Tuple[Any, ...]:
            ...
            self._update_path_traces(robot_path_line, object_path_line, states, frame)
