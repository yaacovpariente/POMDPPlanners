...
def create_continuous_push_belief(
    ...
    Args:
        env: ContinuousPushPOMDP environment instance.
    ...
    if belief_type not in _SUPPORTED_TYPES:
        raise ValueError(
            f"ContinuousPushPOMDP does not support {belief_type}. " f"Supported: {_SUPPORTED_TYPES}"
        )
