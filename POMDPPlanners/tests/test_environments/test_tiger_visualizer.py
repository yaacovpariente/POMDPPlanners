...
from POMDPPlanners.environments.tiger_pomdp.visualizer.tiger_visualizer import (
    CANVAS_SIZE,
    TigerVisualizer,
    _background,
...
def test_cache_loads_art_once_and_frames_do_not_mutate_background(tmp_path):
    ...
    with patch(
        "POMDPPlanners.environments.tiger_pomdp.visualizer.tiger_visualizer.Image.open", wraps=original_open
    ) as opened:
