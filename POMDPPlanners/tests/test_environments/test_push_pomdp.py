...
class TestPushPOMDP:
    ...
    def test_reward_difference_obstacle_vs_safe(self):
        ...
        assert obstacle_reward < safe_reward, \
    ...
    def test_robot_obstacle_collision_penalty(self):
        ...
        assert obstacle_reward < near_obstacle_reward, \
        ...
        assert abs(obstacle_reward - expected_obstacle_reward) < 1e-6, \
            f"Expected obstacle reward {expected_obstacle_reward}, got {obstacle_reward}"
        assert abs(near_obstacle_reward - expected_near_reward) < 1e-6, \
    ...
    def test_object_obstacle_collision_penalty(self):
        ...
        assert object_obstacle_reward < object_near_obstacle_reward, \
        ...
        # Verify the penalty is applied correctly
        assert abs(object_obstacle_reward - expected_obstacle_reward) < 1e-6, \
            f"Expected object obstacle reward {expected_obstacle_reward}, got {object_obstacle_reward}"
        assert abs(object_near_obstacle_reward - expected_near_reward) < 1e-6, \
    ...
    def test_both_robot_and_object_obstacle_collision(self):
        ...
        assert both_obstacle_reward < both_safe_reward, \
        ...
        assert abs(both_obstacle_reward - expected_obstacle_reward) < 1e-6, \
            f"Expected both obstacle reward {expected_obstacle_reward}, got {both_obstacle_reward}"
        assert abs(both_safe_reward - expected_safe_reward) < 1e-6, \
