...
:mod:`POMDPPlanners.environments.safety_ant_velocity_pomdp.safety_ant_velocity_pomdp_beliefs`.
"""
...
class TestCreateSafetyAntVelocityBelief:
    def test_default_returns_vectorized(self, env):
        ...
        Given: A SafeAntVelocityPOMDP environment.
        When: create_safety_ant_velocity_belief is called with default arguments.
        Then: A VectorizedWeightedParticleBelief is returned.

        Test type: unit
        """
        belief = create_safety_ant_velocity_belief(env, n_particles=50)
    ...
    def test_particle_type_returns_weighted(self, env):
        ...
        Given: A SafeAntVelocityPOMDP environment.
        When: create_safety_ant_velocity_belief is called with BeliefType.PARTICLE.
        Then: A WeightedParticleBelief is returned.

        Test type: unit
        """
        belief = create_safety_ant_velocity_belief(
    ...
    def test_unsupported_type_raises(self, env):
        ...
        Given: A SafeAntVelocityPOMDP environment.
        When: create_safety_ant_velocity_belief is called with BeliefType.GAUSSIAN.
        Then: A ValueError is raised.

        Test type: unit
        """
        with pytest.raises(ValueError, match="does not support"):
            create_safety_ant_velocity_belief(env, belief_type=BeliefType.GAUSSIAN)
    ...
    def test_n_particles_respected(self, env):
        ...
        Given: A SafeAntVelocityPOMDP environment.
        When: create_safety_ant_velocity_belief is called with n_particles=30.
        Then: The belief has exactly 30 particles.

        Test type: unit
        """
        belief = create_safety_ant_velocity_belief(env, n_particles=30)
        assert isinstance(belief, VectorizedWeightedParticleBelief)
    ...
    def test_sample_shape(self, env):
        ...
        Given: A SafeAntVelocityPOMDP environment and a created belief.
